...
public class DisplayDonorsActivity extends AppCompatActivity {
    ...
    void initializeComponents() {
        ...
        bloodFilter = findViewById(R.id.bloodFilterDonor);
    ...
    private void updateList(String s,String bloodFilter) {
        temp.clear();
        for( User v : users){
            if((v.getDistrict().toUpperCase().contains(s) || s.equalsIgnoreCase("ALL")) && (bloodFilter.equalsIgnoreCase("ALL") || v.getBloodGroup().equalsIgnoreCase(bloodFilter) )) {
