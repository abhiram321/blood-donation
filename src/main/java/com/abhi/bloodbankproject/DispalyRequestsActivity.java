package com.abhi.bloodbankproject;
...
import com.abhi.bloodbankproject.adapters.UserAdapter;
import com.abhi.bloodbankproject.model.User;
...
public class DispalyRequestsActivity extends AppCompatActivity {
    ...
    private void updateList(String toString,String bloodFilter) {
        temp.clear();
        for( User v : requests){
            if((v.getDistrict().toUpperCase().contains(toString)||toString.equalsIgnoreCase("ALL") && (bloodFilter.equalsIgnoreCase("all") || v.getBloodGroup().equalsIgnoreCase(bloodFilter)))) {
    ...
    private void initializeComponents() {
        ...
        bloodFilter = findViewById(R.id.bloodFilterRequests);
        String[] bloodGroups = {"All","A+","B+","AB+","O+","A-","B-","AB-","O-"};
        ArrayAdapter<String> bloodAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1,bloodGroups);
        bloodFilter.setAdapter(bloodAdapter);
        ...
        popupMenu.setOnMenuItemClickListener(item -> {
            if(item.getItemId() == R.id.changePass){
                ...
                startActivity(new Intent(DispalyRequestsActivity.this,facts.class));
                return true;
        ...
        districtFilter.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                updateList(s.toString(),bloodFilter.getSelectedItem().toString());
            }
        });
        ...
        bloodFilter.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                updateList(districtFilter.getText().toString(),bloodGroups[position]);
            }
    ...
    private void getRequests() {
        FirebaseDatabase.getInstance().getReference("Donors").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                updateList(districtFilter.getText().toString(),bloodFilter.getSelectedItem().toString());
